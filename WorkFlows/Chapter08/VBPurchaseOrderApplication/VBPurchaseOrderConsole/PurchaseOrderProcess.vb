...
Public Class PurchaseOrderProcess
    ...
    Private Sub AddPurchaseOrder_ExecuteCode(ByVal sender As System.Object, ByVal e As System.EventArgs)
        InsertPurchaseOrder.SQLStatement = "Insert into tblPurchaseOrders(StrPartNumber,DtePurchaseDate,DteExpectedDate," & _
    ...
    End Sub
    Private Sub GetPurchaseOrderNumber_ExecuteCode(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim IntPurchaseOrderID As Integer
        IntPurchaseOrderID = InsertPurchaseOrder.NewID
        ...
        End Select
        UpdatePurchaseOrderNumber.SQLStatement = "Update tblpurchaseorders set StrPurchaseOrderNumber='" & StrPurchaseOrderNumber & "' " & _
