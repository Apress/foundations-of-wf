<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmployeeMaintenance.aspx.vb" Inherits="EmployeeMaintenance" %>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#0C4690" Height="278px" Style="z-index: 100;
            ...
            <p>
                ...
                <asp:LinkButton ID="btnQuestionMaintenance" runat="server" BackColor="Transparent"
                    ...
                    left: 16px; position: absolute; top: 135px" Width="184px">Question Maintenance</asp:LinkButton>
